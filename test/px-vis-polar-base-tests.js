...
function runBaseTests() {
  px_vis_polar_1 = document.getElementById('px_vis_polar_1');

  suite('Base Automation Tests for px-vis-polar', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-vis-polar fixture is created', function() {
      assert.isTrue(document.getElementById('px_vis_polar_1') !== null);
    });
